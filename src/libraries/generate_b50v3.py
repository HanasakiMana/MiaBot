...
from CONST import b50_resource,plate_path, frame_path, jacket_path, font_path, customize_path
...
class GenerateB50(object):
    ...
    async def generate(self):
        ...
        output.paste(network_img, (1575, 15), mask=network_img)
        version_img = self.text_to_image('Ver.DX1.25', 16, font='/msyhbd.ttc')
        output.paste(version_img, (1460, 18), mask=version_img)
        ...
        output.paste(generated_time, (1380, 65), mask=generated_time)
